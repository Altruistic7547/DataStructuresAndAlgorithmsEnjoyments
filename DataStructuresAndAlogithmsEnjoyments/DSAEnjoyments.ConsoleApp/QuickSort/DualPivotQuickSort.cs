...
{
    internal class DualPivotQuickSort
    {
        ...
        private static void DuallPivotQuickSort(int[] A, int l, int r)
        {
            ...
            DuallPivotQuickSort(A, l, pair.Item1);
            DuallPivotQuickSort(A, pair.Item1, pair.Item2);
            DuallPivotQuickSort(A, pair.Item2, r);
        }
        ...
        private static void ExampleDualPivotQuickSort()
        {
            ...
            DuallPivotQuickSort(A, 0, A.Length);
